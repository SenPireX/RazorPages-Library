...
public class LoanRepository : Repository<Loan>
{
    ...
    public (bool success, string message) Insert(Guid bookGuid, Guid libraryGuid, Guid memberGuid, DateTime loanDate,
        DateTime dueDate)
    {
